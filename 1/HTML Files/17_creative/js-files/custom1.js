...
"use strict"; 
       ...
       //    $.fancybox("#hidden_pix_15");
        ...
        //      Submit (Creative 17)
        //======================================================================================================
        $("#subscribe_btn_17").click(function() { 
            //get input field values
            var user_email      = $('.creative_video_header input[name=email]').val();
            ...
            if(user_email==""){ 
                ...
                $('.creative_video_header input[name=email]').css('border-color','red'); 
                proceed = false;
            }
            //$.fancybox("#hidden_pix_17");
            ...
            if(proceed) 
            {
                ...
                $.post('pix_mail/contact_me_1.php', post_data, function(response){  
                    ...
                    if(response.type == 'error')
                    {
                        ...
                        //reset values in all input fields
                        $('.creative_video_header #contact_form input').val(''); 
                        $('.creative_video_header #contact_form textarea').val(''); 
                    }
                    
                    $(".creative_video_header #result").hide().html(output).slideDown();
                }, 'json');
        ...
        //reset previously set border colors and hide all message on .keyup()
        $(".creative_video_header #contact_form input, .creative_video_header #contact_form textarea").keyup(function() { 
            $(".creative_video_header #contact_form input, .creative_video_header #contact_form textarea").css('border-color',''); 
            $(".creative_video_header #result").slideUp();
        });
        //======================================================================================================
